...
@dataclass
class SunrisePeriod:
    """Represents the sunrise period from dawn to end of morning golden
    hour + 30 minutes."""
...
@dataclass
class SunsetPeriod:
    """Represents the sunset period from evening golden hour - 30 minutes
    to dusk."""
...
class SunEventPeriod:
    """Represents either a sunrise or sunset period."""
